...
public class BattlefieldMarco {
    ...
    // boolean sofreuDano = false; // ideia
    ...
    private void verQuemAtacaPrimeiro(int ordemDeAtaque, Guerreiro guerreiro1, Guerreiro guerreiro2,
        ...
        int vidaAntGuerreiro1 = guerreiro1.getEnergia();
        int vidaAntGuerreiro2 = guerreiro2.getEnergia();
        ...
        int vidaDepGuerreiro1 = guerreiro1.getEnergia();
        int vidaDepGuerreiro2 = guerreiro2.getEnergia();

        if (vidaAntGuerreiro1 == vidaDepGuerreiro1) {
            if (vidaAntGuerreiro2 == vidaDepGuerreiro2) {
    ...
    // private boolean sofreuDano(LinkedList<Guerreiro> fila){
    // if(!fila.isEmpty)
    // }
